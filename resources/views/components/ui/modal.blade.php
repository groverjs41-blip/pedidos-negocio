...
<template x-teleport="body">
    <div
        ...
        x-init="
            $watch('show', value => {
                if (value) {
                    ...
                    $nextTick(() => {
                        const firstInput = $el.querySelector('input:not([type=hidden]), select, textarea, button:not([data-close])');
        ...
        x-on:keydown.escape.window="handleClose()"
        style="display: none; position: fixed; inset: 0; z-index: 99999; overflow-y: auto; padding: 1rem;"
    ...
    >
        ...
        <div
            ...
            style="position: fixed; inset: 0; background: rgba(0, 0, 0, 0.75); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px);"
        ></div>
