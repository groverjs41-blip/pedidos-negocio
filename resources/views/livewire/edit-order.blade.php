<div class="create-order-layout">
    <style>
        /* Re-use identical mobile-first layouts and styling rules */
        .create-order-layout {
            display: flex;
    ...
    <div wire:offline class="offline-banner">
        ⚠️ SIN CONEXIÓN - Los cambios NO se guardarán.
    </div>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <h1 style="font-size: 1.3rem; font-weight: 700;">Editar Pedido {{ $order->number }}</h1>
        <a href="{{ route('pedidos.index') }}" class="btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.8rem;">Volver</a>
    </div>
